...
export default function Profile() {
  ...
  const cardStyle = {
    ...
    padding: '20px',
    borderRadius: '12px',
    boxShadow: isDark ? '0 2px 8px rgba(255, 255, 255, 0.05)' : '0 2px 8px rgba(0, 0, 0, 0.1)',
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={responsiveLayout}>
        {/* Left Box */}
        <div style={leftStyle}>
          <img src={userProfile.photoUrl || '/images/5.png'} alt="Profile" style={photoStyle} />
        ...
        <div style={rightStyle}>
          <div style={{ ...cardStyle }}>
            <div>
              <strong>Organization:</strong> {userProfile.org}{' '}
            </div>
          </div>
          <div style={cardStyle}>
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8 }}>Contact Info</div>
            <div>
          ...
          <div style={cardStyle}>
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8 }}>Plan</div>
            <div>
              <strong>Name:</strong> {userProfile.plan}{' '}
            </div>
            <div>
              <strong>Expiry:</strong> Not Applicable{' '}
            </div>
            <div>
              <strong>Payment:</strong> Not Applicable{' '}
            </div>
          </div>
        </div>
      </div>
